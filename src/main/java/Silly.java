...
public class Silly implements Comparable<Silly>{
    ...
    public Silly(String first, String second){     //We initiate the constructor calling back the Silly class
        this.name = first + second;  // We set the name of our object with both strings
    };
     ...
     */
    @Override
    public int compareTo(Silly other) { return this.name.length() - other.name.length(); }
}
